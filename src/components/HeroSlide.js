...
import { StyleSheet, ImageBackground, View, Text, Image, Pressable, TouchableOpacity } from "react-native";
  ...
  return(
    ...
    >
      <View style={styles.heroLeft}>
        ...
        <Text style={styles.descr}>Уникальная косметическая{"\n"}серия в линейке Plazan</Text>
        <TouchableOpacity 
