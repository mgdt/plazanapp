...
const cities = ["г.Москва", "г.Санкт-Петербург", "г.Казань", "г.Новосибирск", "г.Екатеринбург", "г.Уфа"]
    ...
    <LinearGradient colors={["#f7f7f7", "#fff"]} style={styles.container}>
      <ScrollView style={styles.scroll}>
        ...
        <View style={styles.statusDescrContainer}>
          ...
          <Text style={styles.statusDescrActive}>Доставка</Text>
          <Text style={styles.statusDescr}>Оплата</Text>
        </View>
        <Text style={[styles.subTitle, {marginBottom: 25,}]}>Населенный пункт</Text>
        <SelectDropdown
          buttonStyle={{
            marginBottom: 47,
        ...
        />
        <Text style={[styles.subTitle, {marginBottom: 25,}]}>Способ доставки</Text>
        <RadioSelect
          title="Курьер"
