...
export const OrderFourthForm = (props) => {
  ...
  return(
    <SafeAreaView style={{flex: 1,}}>
      ...
      >
        <ReturnIcon
          onPress={() => navigation.navigate("OrderThirdForm")}
        />
        ...
        <View style={styles.statusDescrContainer}>
          <Text style={styles.statusDescrPrev}>Получатель</Text>
          <Text style={styles.statusDescrPrev}>Доставка</Text>
          <Text style={styles.statusDescrActive}>Оплата</Text>
        </View>
        <Text style={[styles.subTitle, {marginBottom: 25,}]}>Выберите способ оплаты</Text>
        ...
        <Text style={[styles.subTitle, {marginBottom: 25,}]}>Проверьте детали заказа</Text>
        <View style={styles.detailsContainer}>
          <Text style={styles.detailsTitle}>Получатель</Text>
          <Text style={styles.detailsText}>Екатерина Иванова</Text>
          <Text style={styles.detailsText}>+7 (938) 228-33-44</Text>
          <Text style={styles.detailsText}>katty.kat@mail.ru</Text>

          <Text style={styles.detailsTitle}>Способ доставки</Text>
          <Text style={styles.detailsText}>Доставка курьером</Text>

          <Text style={styles.detailsTitle}>Адрес доставки</Text>
          <Text style={styles.detailsText}>г. Москва, Тверская ул., 39/3, кв. 50</Text>
