    ...
    <View style={styles.container}>
      ...
      >
        <View style={styles.mainContainer}>
          ...
          <ReturnIcon style={{left: 10, top: -2}} 
          ...
          <View style={styles.presentContainer}>
            ...
            <Text style={styles.presentDescr}>При подтверждении заказа{'\n'}менеджер сообщит подробности</Text>
            <PresentIcon style={{position: "absolute", right: 0, bottom: 0,}}/>
          </View>
          <MainButton 
